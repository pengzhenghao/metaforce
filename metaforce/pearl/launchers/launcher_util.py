...
from metaforce.pearl.core import logger
from metaforce.pearl.launchers import config
from metaforce.pearl.torch.pytorch_util import set_gpu_mode
...
def run_experiment_here(
    ...
    set_seed(seed)
    set_gpu_mode(use_gpu and torch.cuda.is_available())
