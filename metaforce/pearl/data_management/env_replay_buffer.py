...
from metaforce.pearl.data_management.simple_replay_buffer import SimpleReplayBuffer
...
def get_dim(space):
    if isinstance(space, Box):
        ...
        from metaforce.pearl.rand_param_envs.gym.spaces.box import Box as OldBox
