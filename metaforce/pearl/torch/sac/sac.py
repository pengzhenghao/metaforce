...
from metaforce.pearl.core.eval_util import create_stats_ordered_dict
from metaforce.pearl.core.rl_algorithm import MetaRLAlgorithm
...
class PEARLSoftActorCritic(MetaRLAlgorithm):
    ...
    def _take_step(self, indices, context):
        ...
        v_pred = self.vf(obs, task_z.detach())  # TODO: why detach here???
        ...
        policy_reg_loss = mean_reg_loss + std_reg_loss + pre_activation_reg_loss    # TODO: why add so many???
