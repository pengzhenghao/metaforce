...
from metaforce.pearl.core.tabulate import tabulate
...
def dump_tabular(*args, **kwargs):
    ...
    log_to_ray = kwargs.pop("log_to_ray", False)
    if log_to_ray:
        from ray.tune import report
        data = {k: eval(v) for k, v in _tabular}
        #
        data["episode_reward_mean"] = data["AverageReturn_all_test_tasks"]
        data["mean_loss"] = data["AverageReturn_all_train_tasks"]
        report(**data)
