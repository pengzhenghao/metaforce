...
from metaforce.pearl.core import logger, eval_util
...
class MetaRLAlgorithm(metaclass=abc.ABCMeta):
    ...
    def train(self):
        ...
        for it_ in gt.timed_for(    # TODO: add gtimer??? I dont like it
            ...
            # Sample data from train tasks. sample tranjectories for all tasks
    ...
    def _try_to_eval(self, epoch):
        ...
        if self._can_evaluate():
            ...
            logger.dump_tabular(with_prefix=False, with_timestamp=False, log_to_ray=True)
        else:
